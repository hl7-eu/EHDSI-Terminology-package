...
* ^identifier.value = "urn:uuid:1.3.6.1.4.1.12559.11.10.1.3.1.42.66"

* http://loinc.org/#18722-9 "Fertility studies (set)"
* http://loinc.org/#26436-6 "Laboratory studies (set)"
* http://loinc.org/#18719-5 "Chemistry studies (set)"
* http://loinc.org/#18725-2 "Microbiology studies (set)"
* http://loinc.org/#18723-7 "Hematology studies (set)"
* http://loinc.org/#18728-6 "Toxicology studies (set)"
* http://loinc.org/#18717-9 "Blood bank studies (set)"
