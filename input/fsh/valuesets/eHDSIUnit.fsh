...
* http://unitsofmeasure.org//10*9 "per billion"
* http://unitsofmeasure.org//L "per liter"
* http://unitsofmeasure.org//min "per minute"
* http://unitsofmeasure.org/[drp] "drop (1/12 milliliter)"
...
* http://unitsofmeasure.org/{#}/a "number per annum (year)"
* http://unitsofmeasure.org/{AHF'U} "American Hospital Formulary unit"
...
* http://unitsofmeasure.org/{TmStp} "time stamp"
...
* http://unitsofmeasure.org/eq/mL "equivalent per milliliter"
* http://unitsofmeasure.org/F "Farad"
* http://unitsofmeasure.org/fL "femtoliter"
* http://unitsofmeasure.org/fmol/L "femtomole per liter"
* http://unitsofmeasure.org/fmol/mg{cyt_prot} "femtomole per milligram of cytosol protein"
* http://unitsofmeasure.org/fmol/mL "femtomole per milliliter"
...
* http://unitsofmeasure.org/kat/L "katal per liter"
...
* http://unitsofmeasure.org/mL/(8.h)/kg "milliliter per 8 hour per kilogram"
* http://unitsofmeasure.org/mL/{beat}/m2 "milliliter per heart beat per square meter"
* http://unitsofmeasure.org/mL/cm[H2O] "milliliter per centimeter of water"
* http://unitsofmeasure.org/mL/d "milliliter per day"
* http://unitsofmeasure.org/mL/s "milliliter per second"
* http://unitsofmeasure.org/mmol/h/mg{prot} "millimole per hour per milligram of protein"
* http://unitsofmeasure.org/Ms "megasecond"
* http://unitsofmeasure.org/mU/g "milli enzyme unit per gram"
...
* http://unitsofmeasure.org/pg/mL{sLT} "picogram per milliliter sulfidoleukotrienes"
* http://unitsofmeasure.org/ps "picosecond"
* http://unitsofmeasure.org/s/{control} "second per control"
* http://unitsofmeasure.org/t "metric ton"
...
* http://unitsofmeasure.org/umol/10*6{RBC} "micromole per million red blood cell"
...
* http://unitsofmeasure.org//10*6 "per million"
* http://unitsofmeasure.org//cm[H2O] "per centimeter of water"
* http://unitsofmeasure.org//g{creat} "per gram of creatinine"
...
* http://unitsofmeasure.org/[foz_us] "fluid ounce (US)"
* http://unitsofmeasure.org/[ft_i] "foot (international)"
...
* http://unitsofmeasure.org/[syd_i] "square yard (international)"
* http://unitsofmeasure.org/{#} "number"
* http://unitsofmeasure.org/{#}/g "number per gram"
* http://unitsofmeasure.org/{CH100'U} "complement CH100 unit"
* http://unitsofmeasure.org/{clock_time} "clock time e.g 12:30PM"
* http://unitsofmeasure.org/{copies}/mL "copies per milliliter"
* http://unitsofmeasure.org/{copies}/ug "copies per microgram"
* http://unitsofmeasure.org/{Ehrlich'U}/dL "Ehrlich unit per deciliter"
...
* http://unitsofmeasure.org/g/g{creat} "gram per gram of creatinine"
* http://unitsofmeasure.org/g{Hb} "gram of hemoglobin"
* http://unitsofmeasure.org/g{total_prot} "gram of total protein"
* http://unitsofmeasure.org/K "degree Kelvin"
* http://unitsofmeasure.org/K/W "degree Kelvin per Watt"
...
* http://unitsofmeasure.org/mU/g{prot} "milli enzyme unit per gram of protein"
...
* http://unitsofmeasure.org/ng/mg{prot} "nanogram per milligram of protein"
* http://unitsofmeasure.org/ng/mL "nanogram per millliiter"
* http://unitsofmeasure.org/nmol/min/mg{prot} "nanomole per minute per milligram of protein"
* http://unitsofmeasure.org/nmol/mmol "nanomole per millimole"
* http://unitsofmeasure.org/nmol/mol{creat} "nanomole per mole creatinine"
...
* http://unitsofmeasure.org/mg/mol "milligram per mole"
* http://unitsofmeasure.org/nmol/kg "nanomole per kilogram"
* http://unitsofmeasure.org/pmol/kg "picomole per kilogram"
...
* http://unitsofmeasure.org/%{pooled_plasma} "percent normal pooled plasma"
...
* http://unitsofmeasure.org/[mclg'U] "Maclagan unit"
* http://unitsofmeasure.org/[ppth] "part per thousand"
* http://unitsofmeasure.org/[pptr] "part per trillion"
* http://unitsofmeasure.org/[tsp_us] "teaspoon (US)"
...
* http://unitsofmeasure.org/{score} "score"
...
* http://unitsofmeasure.org/h/d "hour per day"
* http://unitsofmeasure.org/kat/kg "katal per kilogram"
* http://unitsofmeasure.org/kU/g "kilo enzyme unit per gram"
...
* http://unitsofmeasure.org/nmol/mg{prot}/h "nanomole per milligram of protein per hour"
...
* http://unitsofmeasure.org/nmol/[IU] "nanomole per international unit"
* http://unitsofmeasure.org/[arb'U]/L "arbitrary unit per liter"
...
* http://unitsofmeasure.org//10*10 "per 10 billion"
...
* http://unitsofmeasure.org/{breaths}/min "breaths per minute"
...
* http://unitsofmeasure.org/{rel_saturation} "relative saturation"
* http://unitsofmeasure.org/{Tscore} "t score"
...
* http://unitsofmeasure.org/atm "atmosphere"
...
* http://unitsofmeasure.org/g/m2 "gram per square meter"
* http://unitsofmeasure.org/kg/L "kilogram per liter"
* http://unitsofmeasure.org/kg/m2 "kilogram per square meter"
* http://unitsofmeasure.org/kg/min "kilogram per minute"
* http://unitsofmeasure.org/kg/s "kilogram per second"
...
* http://unitsofmeasure.org/min/wk "minute per week"
...
* http://unitsofmeasure.org/nmol/min/mg{protein} "nanomole per minute per milligram protein"
...
* http://unitsofmeasure.org/1 "Unit"
...
* http://unitsofmeasure.org//100{WBCs} "per 100 white blood cells"
...
* http://unitsofmeasure.org/{yyyy} "year"
...
* http://unitsofmeasure.org/h/wk "hour per week"
...
* http://unitsofmeasure.org/L/s "liter per second"
...
* http://unitsofmeasure.org/nmol/h/mg{prot} "nanomole per hour per milligram of protein"
...
* http://unitsofmeasure.org/10*-3 "ten to the power of minus three"
...
* http://unitsofmeasure.org/%{vol} "percent by volume"
* http://unitsofmeasure.org//(12.h) "per twelve hour"
...
* http://unitsofmeasure.org/[ft_us]/[ft_us] "feet (US) per feet (US)"
* http://unitsofmeasure.org/[gal_us] "gallon (US)"
...
* http://unitsofmeasure.org/[MET].min/wk "metabolic equivalent minute per week"
* http://unitsofmeasure.org/[oz_av] "ounce (US and British)"
* http://unitsofmeasure.org/[oz_tr] "Troy ounce"
* http://unitsofmeasure.org/[ppb] "part per billion"
* http://unitsofmeasure.org/[pt_us] "pint (US)"
* http://unitsofmeasure.org/{#}/{platelet} "molecule per platelet"
...
* http://unitsofmeasure.org/{Ct_value} "Cycle threshold value"
...
* http://unitsofmeasure.org/{Zscore} "z score"
* http://unitsofmeasure.org/10*12/L "trillion per liter"
* http://unitsofmeasure.org/10*3/uL "thousand per microliter"
...
* http://unitsofmeasure.org/cSt "centistoke"
* http://unitsofmeasure.org/eq/mmol "equivalent per millimole"
* http://unitsofmeasure.org/eq/umol "equivalent per micromole"
* http://unitsofmeasure.org/fmol/mg{prot} "femtomole per milligram of protein"
...
* http://unitsofmeasure.org/kg/m3 "kilogram per cubic meter"
...
* http://unitsofmeasure.org/mU/mL "milli enzyme unit per milliliter"
* http://unitsofmeasure.org/mV/s "millivolt per second"
...
* http://unitsofmeasure.org/nmol/m/mg{prot} "nanomole per meter per milligram of protein"
* http://unitsofmeasure.org/nmol/mg{prot} "nanomole per milligram of protein"
...
* http://unitsofmeasure.org/pmol/mg{prot} "picomole per milligram of protein"
...
* http://unitsofmeasure.org/um/s "microns per second"
* http://unitsofmeasure.org/umol/g{Hb} "micromole per gram of hemoglobin"
* http://unitsofmeasure.org/umol/min/g{prot} "micromole per minute per gram of protein"
* http://unitsofmeasure.org/uV "microvolt"
* http://unitsofmeasure.org/wk "week"
* http://unitsofmeasure.org/mmol/m3 "millimole per cubic meter"
...
* http://unitsofmeasure.org//10*12 "per trillion"
...
* http://unitsofmeasure.org/[cin_i] "cubic inch (international)"
...
* http://unitsofmeasure.org/10*8 "100 million"
* http://unitsofmeasure.org/cm/s "centimeter per second"
...
* http://unitsofmeasure.org/kU/L "kilo enzyme unit per liter"
...
* http://unitsofmeasure.org/mU/L "milli enzyme unit per liter"
* http://unitsofmeasure.org/mU/mg "milli enzyme unit per milligram"
* http://unitsofmeasure.org/mU/mmol{creat} "milli enzyme unit per millimole of creatinine"
* http://unitsofmeasure.org/mU/mmol{RBCs} "milli enzyme unit per millimole of red blood cells"
...
* http://unitsofmeasure.org/pmol/h/mg{prot} "picomole per hour per milligram of protein"
* http://unitsofmeasure.org/pmol/H/mg{protein} "picomole per hour per milligram protein"
* http://unitsofmeasure.org/pmol/min "picomole per minute"
* http://unitsofmeasure.org/pmol/umol "picomole per micromole"
* http://unitsofmeasure.org/Torr "Torr"
...
* http://unitsofmeasure.org/[qt_us] "quart (US)"
* http://unitsofmeasure.org/{#}/[HPF] "number per high power field"
* http://unitsofmeasure.org/{#}/d "number per day"
* http://unitsofmeasure.org/{#}/wk "number per week"
...
* http://unitsofmeasure.org/{index} "index value"
...
* http://unitsofmeasure.org/10*5 "one hundred thousand"
...
* http://unitsofmeasure.org/deg "degree (plane angle)"
* http://unitsofmeasure.org/dm2/s2 "square decimeter per square second"
* http://unitsofmeasure.org/eq/L "equivalent per liter"
* http://unitsofmeasure.org/eV "electron Volt"
...
* http://unitsofmeasure.org/g/cm2 "gram per square centimeter"
...
* http://unitsofmeasure.org/kcal/(24.h) "kilocalorie per 24 hour"
...
* http://unitsofmeasure.org/L/min/m2 "liter per minute per sqaure meter"
...
* http://unitsofmeasure.org/min/d "minute per day"
...
* http://unitsofmeasure.org/mU/mL/min "milli enzyme unit per milliliter per minute"
...
* http://unitsofmeasure.org/pmol/min/mg{prot} "picomole per minute per milligram of protein"
...
* http://unitsofmeasure.org/ueq "microequivalent"
...
* http://unitsofmeasure.org/[mi_i] "mile (international)"
...
* http://unitsofmeasure.org/mkat/L "millikatal per liter"
* http://unitsofmeasure.org/ukat/s "microkatal per second"
* http://unitsofmeasure.org/mol/kg.s "mole per kilogram second"
* http://unitsofmeasure.org/g/mol "gram per mole"
* http://unitsofmeasure.org/10*-6 "ten to the power of minus six"
* http://unitsofmeasure.org/10*3.[IU]/L "million international unit per liter"
* http://unitsofmeasure.org/mkat/mol "millikatal per mole"
* http://unitsofmeasure.org/ng/[IU] "nanogram per international unit"
* http://unitsofmeasure.org/pU "pico enzyme unit"
* http://unitsofmeasure.org/akat "attokatal"
* http://unitsofmeasure.org/kU/mol "kilo enzyme unit per mole"
* http://unitsofmeasure.org/amol "attomole"
* http://unitsofmeasure.org/kJ/L "kilojoule per liter"
* http://unitsofmeasure.org/nkat/L "nanokatal per liter"
* http://unitsofmeasure.org/10*3.[arb'U]/L "million arbitrary unit per liter"
* http://unitsofmeasure.org/ukat/d "microkatal per day"
* http://unitsofmeasure.org/10*-9 "ten to the power of minus nine"
* http://unitsofmeasure.org/nmol/m3 "nanomole per cubic meter"
* http://unitsofmeasure.org/mol/d "mole per day"
* http://unitsofmeasure.org/pmol/m3 "picomole per cubic meter"
* http://unitsofmeasure.org/umol/kg.s "micromole per kilogram second"
* http://unitsofmeasure.org/g/min.m2 "gram per minute square meter"
* http://unitsofmeasure.org/um2 "square micrometer"
* http://unitsofmeasure.org/mmol/s "millimole per second"
* http://unitsofmeasure.org/U/kg "enzyme unit per kilogram"
* http://unitsofmeasure.org/10*9/kg "billion per kilogram"
* http://unitsofmeasure.org/ukat/kg "microkatal per kilogram"
* http://unitsofmeasure.org/10*6.[IU]/L "million international unit per liter"
* http://unitsofmeasure.org/umol/m3 "micromole per cubic meter"
* http://unitsofmeasure.org/kg/d "kilogram per day"
* http://unitsofmeasure.org/cm-2 "per square centimeter"
* http://unitsofmeasure.org/10*-3.[IU]/L "ten to the power of minus three international unit per liter"
* http://unitsofmeasure.org/mm2/s "square millimeter per second"
* http://unitsofmeasure.org/10*9 "billion"
* http://unitsofmeasure.org/ukat/L "microkatal per liter"
