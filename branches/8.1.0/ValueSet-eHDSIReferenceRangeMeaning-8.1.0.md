# eHDSI Reference Range Meaning - eHDSI Terminologies v8.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://terminology.ehdsi.eu/ValueSet/eHDSIReferenceRangeMeaning | *Version*:8.1.0 |
| Active as of 2025-11-18 | *Computable Name*:eHDSIReferenceRangeMeaning |
...
```json
{
  ...
  "id" : "eHDSIReferenceRangeMeaning-8.1.0",
