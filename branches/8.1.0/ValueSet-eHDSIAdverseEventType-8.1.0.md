# eHDSI Adverse Event Type - eHDSI Terminologies v8.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **eHDSI Adverse Event Type**

## ValueSet: eHDSI Adverse Event Type 

| | |
| :--- | :--- |
| *Official URL*:http://terminology.ehdsi.eu/ValueSet/eHDSIAdverseEventType | *Version*:8.1.0 |
| Active as of 2025-11-18 | *Computable Name*:eHDSIAdverseEventType |
...
```json
{
  ...
  "id" : "eHDSIAdverseEventType-8.1.0",
