# eHDSI Route of Administration - eHDSI Terminologies v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **eHDSI Route of Administration**

## ValueSet: eHDSI Route of Administration 

| | |
| :--- | :--- |
| *Official URL*:http://terminology.ehdsi.eu/ValueSet/eHDSIRouteofAdministration | *Version*:0.2.0 |
| Active as of 2025-12-23 | *Computable Name*:eHDSIRouteofAdministration |
| *Other Identifiers:*OID:1.3.6.1.4.1.12559.11.10.1.3.1.42.12 | |
...
```json
{
  ...
  "id" : "eHDSIRouteofAdministration-8.1.0",
    ...
    "include" : [
      {
        ...
        "concept" : [
          ...
          {
            "code" : "20089000",
            "display" : "Cardioplegic use"
          },
          {
            "code" : "20090000",
            "display" : "Intradetrusorial use"
          }
        ]
      }
    ]
